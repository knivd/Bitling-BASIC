...
void main(void) {
    ...
    //memcpy(TEXT, "sub x(string @s,int p)\0print s[p]\0end sub\0" "dim int t\0dim string m[10]\0" "for t=1 to 10:m[t]=\"test\"+str$(t,0)+str$(t-1,0)\0" "? \"HERE \";m[t]:next\0" "label back\0input t\0x(@m,t)\0goto back\0" "\x1f", 300);
